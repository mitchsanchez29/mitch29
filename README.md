...
<section id="projects">
  ...
  <div class="projects-grid">
    ...
    <!-- 3. Ads + Looker Studio - WIDE -->
    <div class="project-card c-amber wide">
      <div class="card-top">
        <div class="card-icon">📈</div>
        <span class="card-role">sole builder</span>
      </div>
      <div class="card-title">Facebook & Google Ads Marketing Performance Dashboard</div>
      <div class="flow">
        <span class="flow-node">Facebook Ads</span>
        <span class="flow-arrow">→</span>
        <span class="flow-node">Google Ads</span>
        <span class="flow-arrow">→</span>
        <span class="flow-node">Looker Studio Connectors</span>
        <span class="flow-arrow">→</span>
        <span class="flow-node">Live Dashboard</span>
      </div>
      <div class="card-desc">
        Built a consolidated marketing performance dashboard in Looker Studio connecting both Facebook Ads and Google Ads data sources. Provides real-time visibility into campaign spend, reach, conversions, and ROAS — replacing manual reporting and delivering a single source of truth for marketing decisions.
      </div>
      <div class="tags">
        <span class="tag amber">Facebook Ads</span>
        <span class="tag amber">Google Ads</span>
        <span class="tag">Looker Studio</span>
        <span class="tag">Data Connectors</span>
    ...
    <div class="project-card c-coral">
      ...
      <div class="flow">
        <span class="flow-node">Raw Data</span>
        <span class="flow-arrow">→</span>
        <span class="flow-node">Apps Script merge</span>
        <span class="flow-arrow">→</span>
        <span class="flow-node">Clean Tracker</span>
        <span class="flow-arrow">→</span>
        <span class="flow-node">Looker Studio</span>
      </div>
      <div class="card-desc">
        Used Google Apps Script to clean and merge payment data from multiple sources into a structured tracker flagging upcoming and overdue payments. Looker Studio report gives management real-time payment status visibility.
      </div>
      <div class="tags">
        <span class="tag accent">Apps Script</span>
        <span class="tag">Data Merging</span>
        <span class="tag">Looker Studio</span>
  ...
  <div class="skills-categories">
    ...
    <div class="skill-group">
      ...
      <div class="skill-list">
        ...
        <div class="skill-item"><span class="skill-dot" style="background:var(--amber)"></span>Airtable</div>
    ...
    <div class="about-meta">
      ...
      <div class="meta-item">
        ...
        <div>
          ...
          <div class="meta-value">OnlineJobs.ph · Upwork · LinkedIn</div>
        </div>
      </div>
    </div>
  </div>
